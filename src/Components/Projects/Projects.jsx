...
const projects = [
  ...
  { title: 'Portfolio', imgsrc: Portfolio, type: 'Portfolio Project', tec: 'React, Email.js, Chatbot', desc: 'A personal portfolio website created to showcase my projects, journey, and growth while reflecting my design style and professional identity.', git: 'https://github.com/Sehar-Tahir/Sehar_Portfolio', demo: 'https://sehar-portfolio.vercel.app/' },
