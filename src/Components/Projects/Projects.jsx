...
const projects = [
  ...
  { title: 'Personal Portfolio', imgsrc: PS, type: 'Portfolio Project', tec: 'React, Tailwind CSS Email.js, Chatbot', desc: 'A complete redesign of my personal portfolio with a new violet-accented design system, route-style section labels, and a workflow-inspired signature layout reflecting my dual identity as a web developer and GHL automation specialist.', git: 'https://github.com/Sehar-Tahir/Sehar_Portfolio_Site', demo: 'https://sehar-portfolio-site.vercel.app/' },
